...
register(
    id="CartPendulum-v0",
    entry_point="gymnasium.envs.classic_control.cart_pendulum:CartPendulumEnv",
    vector_entry_point="gymnasium.envs.classic_control.cart_pendulum:CartPendulumVectorEnv",
